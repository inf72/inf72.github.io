            ...
            <div class="single-page-content">
              ...
              <article class="post">
                ...
                <div class="post-thumbnail">
                  <img src="img/blog/blog-1-full.jpg" alt="image">
                </div>
                ...
                <div class="post-content">
                  ...
                  <header class="entry-header">
                    ...
                    <div class="entry-meta entry-meta-top">
                      <span><a href="#" rel="category tag">Mechatronics</a></span>        
                    </div>
                    <!-- /Entry meta -->

                    <h2 class="entry-title">What is Mechatronics ?</h2>
                  </header>
                  <!-- /Entry header -->
                  ...
                  <div class="entry-content">
                    <div class="row">
                      <div class=" col-xs-12 col-sm-12 ">
                        <div class="col-inner">
                          <p>Mechatronics is a multidisciplinary field that refers to the skill sets needed in the contemporary, 
                            advanced automated manufacturing industry. At the intersection of mechanics, electronics, and computing, 
                            mechatronics specialists create simpler, smarter systems. Mechatronics is an essential foundation for the 
                            expected growth in automation and manufacturing. Mechatronics deals with <b>robotics,  control systems, </b>and 
                            <b>electro-mechanical systems</b>. Do you like mechanics, robotics, or production equipment? Do you have a knack for 
                            creative problem solving? Do you enjoy technical and engineering activities? Can you work well as a member of 
                            a team? Mechatronics could be for you.</p>
                  ...
                  <div class="entry-meta entry-meta-bottom">
                    <div class="date-author">
                      <span class="entry-date">
                        <a href="#" rel="bookmark">
                          <i class="far fa-clock"></i> <span class="entry-date"> January 1, 2020</span>
                        </a>
                      </span>
                      <span class="author vcard">
                        <a class="url fn n" href="#" rel="author"> <i class="fas fa-user"></i> Iqbal Nur Fauzi</a>
                      </span>
                    </div>
